...
public class SelectContactActivity extends Activity {
    private ListView id_select_contact;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select_contact);
        id_select_contact = (ListView) findViewById(R.id.id_select_contact);
        final List<Map<String, String>> data = getContactInfo();
        id_select_contact.setAdapter(new SimpleAdapter(this, data,
                R.layout.contact_item_view, new String[] { "name", "phone" },
                new int[] { R.id.tv_name, R.id.tv_phone }));

        id_select_contact.setOnItemClickListener(new AdapterView.OnItemClickListener() {
