package mobilesafe.lzf.com.service;
...
import mobilesafe.lzf.com.db.dao.BlackNumberDao;
            ...
            switch (state) {
                ...
                case TelephonyManager.CALL_STATE_RINGING://响铃状态
                    ...
                    if ("1".equals(mode) || "3".equals(mode)) {
                        ...
                        getContentResolver().registerContentObserver(uri, true, new CallLogObserver
